...
class Cart extends Component {
     render() {
          return (
              <Fragment>
                <Container>   
                    <div className="section-title text-center mb-55 pt-4">
                        ...
                        <Col className="p-1" lg={12} md={12} sm={12} xs={12} >
                            ...
                            <Col className="p-1" lg={12} md={12} sm={12} xs={12} >
                                <Card >                
                                    ...
                                    <Row>
                                            <Col md={3} lg={3} sm={6} xs={6}>
                                                <img alt='' className="cart-product-img" src="https://rukminim1.flixcart.com/image/416/416/knm2s280/mobile/j/x/c/hot-10-play-x688b-infinix-original-imag29gxqzuxkmnk.jpeg?q=70" />
                                            </Col>
